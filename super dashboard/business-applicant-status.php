            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Approved Business</h3>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <p>Count of Approved Business: <span id="approvedCountSpan"></span></p>
    ...
    <script>
      $(document).ready(function () {
        ...
        $('#Approved_tbl').DataTable({
           ...
           // Get the approved count from the response and update the HTML
           var approvedCount = this.api().ajax.json().approvedCount;
           $('#approvedCountSpan').text(approvedCount);
       }
            });
      });
