            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Re-Evalutation of Registration</h3>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <p>Count of Re-Evaluation Business: <span id="reevaluate_count">Loading...</span></p>
    ...
    <script>
      $(document).ready(function () {
        ...
        $('#re_evaluate_tbl').DataTable({
                ...
                // Fetch the count from the table data
                var reEvaluateCount = $('#re_evaluate_tbl').DataTable().rows().count();

                // Display the count on the HTML page
                $('#reevaluate_count').text(reEvaluateCount);
        }
            });
      });
