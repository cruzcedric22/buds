              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <p>Count of Approval Registration: <span id="pendingCount"></span></p>
...
$(document).ready(function () {
          ...
          $('#approval_tbl').DataTable({
                        ...
                        'initComplete': function (settings, json) {
                            // Update the pending count after DataTable is initialized
                            updatePendingCount(json.pendingCount);
                        }
