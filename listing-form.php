                          ...
                          <div class="pf-title">
                            ...
                            <div class="pf-location">
                                ...
                                <div class="location-inputs">
                                  ...
                                  <br>
                                   <input name="BusinessOpenHour"
                                          placeholder="Opening Time"
                                           type="time"
                                           >
                                   <input name="BusinessCloseHour"
                                           type="time"
                                ...
                                <div class="pf-title">
                                  ...
                                  <br>
                                    <input name="BusinessAddress"
                                           type="text"
                                           placeholder="Enter your Complete Address - [Unit No] [Building Name] [Street No] [Street Name] [City]."><br>
                            ...
                            <div class="pf-location">
                                ...
                                <div class="location-inputs">
                                <br><input name="BusinessFb"
                                           type="text"
                                           placeholder="Facebook"
                                           >

                                    <input name="BusinessTwitter"
                                           type="text"
                                           placeholder="Twitter"
                                           >
